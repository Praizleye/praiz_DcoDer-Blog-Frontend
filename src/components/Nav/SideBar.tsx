    ...
    <Box sx={{ display: "flex" }}>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        ...
        <Typography paragraph>
          ...
          mollitia nemo, ducimus ipsa perspiciatis quis deleniti similique
          reprehenderit. Vel laudantium libero magnam consequatur illum sint
          eligendi dolorum excepturi hic!
        </Typography>
      </Box>
    </Box>
  );
